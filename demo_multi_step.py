...
from agent.multi_step_planner import MultiStepPlanner, TestPlan, TestStep, StepType
...
def demo_templates():
    ...
    if plan:
        ...
        print(f"{Fore.GREEN}✓ Plan saved to: test_plans/login_flow.json{Style.RESET_ALL}")
...
def demo_execution(plan: TestPlan):
    ...
    print(f"{Fore.YELLOW}Do you want to execute this plan? (y/n): {Style.RESET_ALL}", end="")
    ...
    try:
        result = executor.execute_plan(plan, url="https://fe-history-mind-ai.vercel.app/")
