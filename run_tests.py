...
def run_tests(verbose=True):
    ...
    print(
        f"{Fore.GREEN}💡 Tip: Tests run in parallel with pytest-xdist{Style.RESET_ALL}"
    )
    print(
        f"{Fore.GREEN}   Use 'pytest -n auto' for automatic CPU detection{Style.RESET_ALL}"
    )
    print()
...
def main():
    ...
    parser.add_argument("--file", help="Run specific test file (e.g., test_memory.py)")
