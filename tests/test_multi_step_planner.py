...
from agent.multi_step_planner import (
    MultiStepPlanner, TestPlan, TestStep, StepType, StepStatus
)
...
class TestPlanClass(unittest.TestCase):
    ...
    def test_get_executable_steps(self):
        ...
        step1 = TestStep(id="step1", name="S1", type=StepType.CLICK, 
                        action="click", depends_on=[])
        step2 = TestStep(id="step2", name="S2", type=StepType.CLICK,
                        action="click", depends_on=["step1"])
    ...
    def test_get_step_by_id(self):
        ...
        step = TestStep(id="step1", name="Test", type=StepType.CLICK,
                       action="click")
        self.plan.add_step(step)
    ...
    def test_get_progress(self):
        ...
        step2 = TestStep(id="step2", name="S2", type=StepType.CLICK,
                        action="click")
        step3 = TestStep(id="step3", name="S3", type=StepType.CLICK,
                        action="click")
...
class TestComplexDependencies(unittest.TestCase):
    ...
    def test_linear_dependencies(self):
        ...
        steps_data = [
            {"id": "step1", "name": "S1", "type": "click", "action": "click", "depends_on": []},
            {"id": "step2", "name": "S2", "type": "click", "action": "click", "depends_on": ["step1"]},
            {"id": "step3", "name": "S3", "type": "click", "action": "click", "depends_on": ["step2"]},
        ]
    ...
    def test_parallel_execution(self):
        ...
        steps_data = [
            {"id": "step1", "name": "S1", "type": "click", "action": "click", "depends_on": []},
            {"id": "step2", "name": "S2", "type": "click", "action": "click", "depends_on": []},
            {"id": "step3", "name": "S3", "type": "click", "action": "click", "depends_on": []},
        ]
        
        plan = self.planner.create_custom_plan("parallel", "Parallel", "Test", steps_data)
    ...
    def test_multiple_dependencies(self):
        ...
        steps_data = [
            {"id": "step1", "name": "S1", "type": "click", "action": "click", "depends_on": []},
            {"id": "step2", "name": "S2", "type": "click", "action": "click", "depends_on": []},
            {"id": "step3", "name": "S3", "type": "click", "action": "click", "depends_on": ["step1", "step2"]},
        ]
    ...
    def test_diamond_dependency(self):
        ...
        steps_data = [
            {"id": "step1", "name": "S1", "type": "click", "action": "click", "depends_on": []},
            {"id": "step2a", "name": "S2a", "type": "click", "action": "click", "depends_on": ["step1"]},
            {"id": "step2b", "name": "S2b", "type": "click", "action": "click", "depends_on": ["step1"]},
            {"id": "step3", "name": "S3", "type": "click", "action": "click", "depends_on": ["step2a", "step2b"]},
        ]
